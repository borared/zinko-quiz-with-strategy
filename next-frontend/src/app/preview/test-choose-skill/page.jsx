  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row w-full max-w-[1100px] h-[65vh] md:h-[70vh] gap-6 px-6 mt-16 md:mt-24">
        ...
        <div className="flex-1 lg:self-center bg-[#1a1a1a]/95 backdrop-blur-md border border-black/30 rounded-xl p-6 md:p-8 flex flex-col-reverse md:flex-row items-center md:items-center gap-6 shadow-xl relative overflow-hidden">
