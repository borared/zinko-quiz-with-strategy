    ...
    <>
      ...
      {hostDisconnected && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div className="bg-zk-panel-bg border-[2px] border-zk-border rounded-lg flex flex-col items-center p-8 max-w-sm w-full text-center space-y-6 transform animate-in zoom-in duration-200">
            ...
            <button 
              ...
              className="flex items-center justify-center gap-2 w-full bg-[#5D3FD3] hover:bg-[#4b33a8] text-white border-[2px] border-zk-border px-6 py-3 rounded-lg font-['Amatic_SC'] text-3xl font-bold transition-colors leading-none pt-4"
            >
