  ...
  return (
    ...
    >
      ...
      >
        {/* FRONT */}
        <div 
          className={`absolute inset-0 backface-hidden flex lg:flex-col items-center justify-center p-4 lg:p-6 border-[4px] border-black rounded-xl shadow-xl cursor-pointer bg-[#1a1a1a]
        ...
        >
           ...
           <div className="flex-1 lg:flex-none flex flex-col justify-center text-left lg:text-center w-full">
              <h3 className="text-2xl lg:text-3xl font-black text-white uppercase tracking-widest">{name}</h3>
           ...
           {isSelected && (
              <button
                ...
                className="bg-[#FF4B4B] text-white font-black px-3 py-2 lg:px-6 lg:py-3 lg:mt-6 border-[3px] border-black rounded-lg shadow hover:translate-y-[1px] transition-all uppercase tracking-widest text-xs lg:text-sm ml-2 lg:ml-0 flex-shrink-0"
              >
                Cancel
              </button>
           )}
           ...
           <AnimatePresence>
             {locker && (
                <motion.div
                  ...
                  animate={{ scale: 1 }}
                  exit={{ scale: 0 }}
                  className="absolute -top-3 -right-3 lg:-top-5 lg:-right-5 bg-zk-blue border-[3px] border-black rounded-xl p-2 lg:p-3 shadow-md flex flex-col items-center z-20"
                >
        ...
        {/* BACK */}
        <div 
          className="absolute inset-0 backface-hidden flex items-center justify-center border-[4px] border-black rounded-xl shadow-xl bg-[#FFCD29] overflow-hidden"
        ...
        >
          ...
          <div className="bg-zk-panel-bg border-[4px] border-black px-6 py-2 rounded-xl transform -rotate-6 z-10 shadow-md">
