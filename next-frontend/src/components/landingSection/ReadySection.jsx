  ...
  return (
    <section className="relative overflow-hidden w-full py-24 px-4 bg-gradient-to-r from-yellow-50 via-white to-teal-50 font-sans">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
        ...
        {/* CTA Button */}
        <button className="font-black text-xl bg-zk-blue text-zk-white border-[4px] border-zk-black px-12 py-5 flex items-center gap-3 transition-colors hover:bg-[#4b33b3] mb-4 rounded-full">
          Start for free
        </button>
