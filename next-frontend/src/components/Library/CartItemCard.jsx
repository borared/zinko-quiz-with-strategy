      ...
      >
        ...
        <div className="relative w-full shrink-0 overflow-hidden border-b-[3px] border-zk-border bg-zk-bg/20 aspect-video">
          ...
          <button
            ...
            className="absolute top-4 right-4 z-10 inline-flex h-8 w-8 items-center justify-center rounded-lg border-[2px] border-zk-border bg-zk-panel-bg text-zk-text !shadow-none transition-colors hover:bg-red-50"
        ...
        <div className="flex flex-col gap-3 p-4">
          <div>
            ...
            <p className="font-['Outfit'] text-lg font-black text-zk-text mt-1">
              {priceLabel}
            </p>
          </div>
          ...
          {isScenery && hasSceneryDetails ? (
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex h-10 flex-1 items-center justify-center gap-1.5 rounded-lg border-[2px] border-zk-border bg-zk-panel-bg px-4 font-['Amatic_SC'] text-xl font-bold leading-none text-zk-text !shadow-none transition-colors hover:bg-zk-bg"
              >
              ...
              <button
                ...
                className="inline-flex h-10 flex-1 items-center justify-center gap-1.5 rounded-lg border-[2px] border-zk-border bg-[#5D3FD3] px-4 font-['Amatic_SC'] text-xl font-bold leading-none text-white !shadow-none transition-colors hover:bg-[#4e33b8] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
              >
                {isCheckingOut ? (
            ...
            <button
              ...
              onClick={() => onCheckout?.(item)}
              disabled={isCheckingOut}
              className="inline-flex h-10 w-full items-center justify-center gap-1.5 rounded-lg border-[2px] border-zk-border bg-[#5D3FD3] px-4 font-['Amatic_SC'] text-xl font-bold leading-none text-white !shadow-none transition-colors hover:bg-[#4e33b8] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isCheckingOut ? (
                <Loader2 size={16} className="animate-spin" />
              ) : (
