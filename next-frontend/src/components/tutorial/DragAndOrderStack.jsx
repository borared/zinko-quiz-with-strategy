...
export default function DragAndOrderStack() {
  const [activeIndex, setActiveIndex] = useState(0);
  const [exitIndex, setExitIndex] = useState(null);

  const cards = [
    'https://hyfqsjidyxufsatveaih.supabase.co/storage/v1/object/public/tutorial/drag1.png',
    'https://hyfqsjidyxufsatveaih.supabase.co/storage/v1/object/public/tutorial/drag2.png',
    'https://hyfqsjidyxufsatveaih.supabase.co/storage/v1/object/public/tutorial/drag3.png',
    'https://hyfqsjidyxufsatveaih.supabase.co/storage/v1/object/public/tutorial/drag4.png',
  ];

  const handleNext = (e) => {
    e.stopPropagation();
    if (exitIndex !== null) return; // Prevent double clicks during transition
  ...
  return (
    ...
    >
      {cards.map((src, index) => {
        ...
        let rotate = relativeIndex === 0 ? 0 : relativeIndex === 1 ? 3 : relativeIndex === 2 ? -3 : 2;
        let opacity = 1;
        let translateX = 0;
