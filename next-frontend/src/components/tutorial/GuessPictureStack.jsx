...
export default function GuessPictureStack() {
  const [activeIndex, setActiveIndex] = useState(0);
  const [exitIndex, setExitIndex] = useState(null);

  const cards = [
    'https://hyfqsjidyxufsatveaih.supabase.co/storage/v1/object/public/tutorial/guess1.png',
    'https://hyfqsjidyxufsatveaih.supabase.co/storage/v1/object/public/tutorial/guess2.png',
  ];
