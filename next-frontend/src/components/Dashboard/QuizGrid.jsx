  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex justify-between items-center">
        <h2 className={"font-black text-2xl uppercase tracking-tight "+(isDiscoveryMode?"text-white":"text-zk-black")}>
          {isDiscoveryMode ? 'Public Quizzes' : (quizzes.length > 0 ? 'Your Quizzes' : 'No Quizzes Found')}
        </h2>
        <button className={"text-sm font-bold "+(isDiscoveryMode?"text-white":"text-zk-black")+" hover:underline"}>View All</button>
      </div>
