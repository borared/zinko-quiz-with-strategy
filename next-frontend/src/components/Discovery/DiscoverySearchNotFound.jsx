...
const DiscoverySearchNotFound = ({ query, onClear }) => (
  ...
  >
    <h2
      className="permanent-marker-regular text-3xl md:text-4xl text-zk-black uppercase mb-2 tracking-tight"
    >
      Not Found
    </h2>

    <p className="text-base md:text-lg font-bold text-zk-black/70 max-w-md mb-2">
    ...
    <Search
      size={20}
      className="absolute top-8 right-10 text-zk-black/20 pointer-events-none hidden lg:block"
      aria-hidden="true"
    />
  </motion.div>
);
