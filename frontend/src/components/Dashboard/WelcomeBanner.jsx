...
const WelcomeBanner = () => {
  ...
  return (
    <div className="bg-white border-[3px] border-zk-black p-8 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
      ...
      <div className="flex gap-6 mt-8">
        {/* Card 1 */}
        <div className="bg-[#7C4DFF] border-[3px] border-zk-black p-6 flex flex-col gap-1 w-64 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-white">
        ...
        {/* Card 2 */}
        <div className="bg-[#FF6B4A] border-[3px] border-zk-black p-6 flex flex-col gap-1 w-64 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-white">
