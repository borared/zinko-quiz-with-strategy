...
const QuizCard = ({ quiz }) => {
  return (
    <div className="bg-white border-[3px] border-zk-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex flex-col h-[320px]">
      {/* Image Area */}
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div className="flex flex-col gap-1">
          {/* Subject Tag */}
          <div className={`${quiz.subjectColor} text-white text-xs font-bold px-2 py-0.5 w-max border-[1.5px] border-zk-black`}>
            {quiz.subject}
          </div>
        ...
        <div className="flex gap-2 mt-2">
          <button className="flex-1 bg-[#5D3FD3] text-white border-[2px] border-zk-black py-2 font-bold text-sm shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:translate-x-[2px] active:shadow-none">
            Host
          </button>
