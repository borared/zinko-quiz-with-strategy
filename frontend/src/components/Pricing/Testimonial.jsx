...
const Testimonial = () => {
  return (
    <div className="w-full max-w-6xl mx-auto mt-20 mb-20">
      <div className="bg-zk-blue border-[4px] border-zk-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-8 md:p-12 flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="flex-1 text-white">
          ...
          <div className="inline-flex items-center gap-4">
            <div className="w-16 h-16 bg-zk-yellow border-[3px] border-zk-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-1">
        ...
        <div className="w-full lg:w-1/3 bg-white border-[4px] border-zk-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-8 text-center flex flex-col justify-center">
          
          <div className="mb-6">
            <h3 className="text-5xl font-black text-[#5D3FD3] mb-1 tracking-tighter">50k+</h3>
            <p className="text-xs font-black text-zk-black uppercase tracking-wider">Active Teachers</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs font-black text-zk-black uppercase tracking-wider">Games Played</p>
          </div>
